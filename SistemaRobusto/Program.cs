...
catch (FormatException ex)
{
    ...
    Console.WriteLine($"DETALHES TECNICOS: {ex.Message}");
    
    //Mostrar mais especificamente a linha de erro 
    //Console.WriteLine($"DETALHES TECNICOS: {ex.InnerEcception}")
    //Console.WriteLine($"DETALHES TECNICOS: {ex.StackTrace}");
}
finally
{
    Console.ResetColor();
